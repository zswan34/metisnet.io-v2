...
@section('content')
        ...
        <h4 class="font-weight-bold py-3 mb-4">
            Home
            <div class="text-muted text-tiny mt-1"><small class="font-weight-normal">Today is {{ \App\Libs\Time::getLocal() }}</small></div>
        </h4>
                                ...
                                <div class="card-body">
                                    <div class="rounded ui-bordered p-3 mb-3">
                                        ...
                                        <div class="media align-items-center mt-3">
                                            <img src="{{ asset('assets/img/avatars/12-small.png') }}" class="d-block ui-w-30 rounded-circle" alt>
                                    ...
                                    <div class="rounded ui-bordered p-3 mb-3">
                                        ...
                                        <div class="media align-items-center mt-3">
                                            <img src="{{ asset('assets/img/avatars/11-small.png') }}" class="d-block ui-w-30 rounded-circle" alt>
                                    ...
                                    <div class="rounded ui-bordered p-3">
                                        ...
                                        <div class="media align-items-center mt-3">
                                            <img src="{{ asset('assets/img/avatars/10-small.png') }}" class="d-block ui-w-30 rounded-circle" alt>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="media pb-1 mb-3">
                            <img src="{{ asset('assets/img/avatars/9-small.png') }}" class="d-block ui-w-40 rounded-circle" alt>
                        ...
                        <div class="media pb-1 mb-3">
                            <img src="{{ asset('assets/img/avatars/8-small.png') }}" class="d-block ui-w-40 rounded-circle" alt>
                            <div class="media-body ml-3">
                        ...
                        <div class="media">
                            <img src="{{ asset('assets/img/avatars/7-small.png') }}" class="d-block ui-w-40 rounded-circle" alt>
                            <div class="media-body ml-3">
